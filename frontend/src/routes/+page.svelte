<script lang="ts">
	...
	import { Game, UserDTO, RoomDTO } from '$lib/socket.svelte';
...
<div class="w-dvw p-2 text-center text-[#333] flex flex-col h-dvh items-center justify-center bg-[#f4f4f9] gap-4">
    <h1 class="text-4xl font-bold">Welcome to Planning Poker</h1>
    <p class="text-lg my-4">Collaborate and estimate tasks efficiently with your team.</p>
    ...
    <a href="/test" class="text-sm">Access to testtttt</a>
	<a href="/test2" class="text-sm">Access to Test2</a>
</div>
